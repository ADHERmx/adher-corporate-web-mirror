...
const Facilities = () => {
  ...
  return (
    <section id="instalaciones" className="py-20 bg-gradient-subtle">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {facilities.map((facility, index) => {
            ...
            return (
              <Card key={index} className="card-hover card-shadow overflow-hidden group">
                ...
                <CardContent>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {facility.specs.map((spec, specIndex) => (
                      <div key={specIndex} className="text-xs bg-secondary/50 rounded px-2 py-1">
                        {spec}
                      </div>
                    ))}
                  </div>
